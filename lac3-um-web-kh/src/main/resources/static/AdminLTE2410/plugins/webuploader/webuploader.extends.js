(function( $ ){
		...
		$.extend(true,this,{
	            ...
	            $itemLi : $('<li id="">\
								<a href="" data-rel="colorbox">\
									<img src="" onerror="this.src=\''+contextPath+'/static/webuploader/404_500.png\'"/>\
									<div class="text">\
										<div class="inner"></div>\
									</div>\
								</a>\
	...
	widget.webuploader.prototype={
            ...
            if ( !(file.getStatus() === WebUploader.File.Status.LOADING) ) {
            	...
            	if ( file.getStatus() === 'invalid' ) {
                    ...
                    self.uploader.makeThumb( file, function( error, src ) {
                        ...
                        if ( error ) {
                            $('img',$li).attr('src',getImgMapingImg({ext:file.ext}));
                            return;
                        }
            	...
            	this.generateThumbnails(file,self.thumbnailWidth,self.thumbnailHeight,function(thum){
		...
		getImgMapingImg:function(attach){
			var imgArray=['jpg','bmp','png','gif','jpeg','icon'];
			if(imgArray.join(' ').indexOf(attach.ext)!=-1){
