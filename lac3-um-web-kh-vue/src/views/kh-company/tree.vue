    ...
    >
      <el-table-column prop="name" label="名称" width="250">
        <template slot-scope="{row}">
          <span v-if="row.attributes.alias === 'Company' && checkPermission(['selfkh_org_view']) === false">
          ...
          <span v-if="row.attributes.alias !== 'Company' && checkPermission(['selfkh_dep_view']) === false">
