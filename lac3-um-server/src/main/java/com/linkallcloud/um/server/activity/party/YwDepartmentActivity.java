                ...
                if (entity.getCompanyId() != null) {
                    ...
                    if (company != null) {
                        ...
                        if (entity.getParentId() != null && !Strings.isBlank(entity.getParentClass())
                                && "YwDepartment".equals(entity.getParentClass())) {
                            YwDepartment parentDep = dao().fetchById(t, entity.getParentId());
                            entity.setFullName(parentDep.getFullName() + entity.getName());
                        } else {
                            entity.setFullName(company.getName() + entity.getName());
                        }
                    }
                }
            }
