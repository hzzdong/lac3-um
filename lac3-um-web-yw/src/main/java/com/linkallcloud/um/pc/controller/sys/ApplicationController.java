...
public class ApplicationController extends BaseLController<Application, IApplicationManager> {
    ...
    @RequestMapping(value = {"/saveMappingInter"}, method = {org.springframework.web.bind.annotation.RequestMethod.POST})
    @WebLog(db = true)
    @ResponseBody
    ...
    public @ResponseBody
    Result<Page<Application>> page4KhCompany(@RequestBody WebPage webPage, Trace t,
    ...
    public @ResponseBody
    Result<Page<Application>> page4YwRole(@RequestBody WebPage webPage, Trace t,
                                          AppVisitor av) throws IllegalParameterException {
        Page<Application> page = webPage.toPage();
    ...
    public @ResponseBody
    Result<Page<Application>> page4YwSysRole(@RequestBody WebPage webPage, Trace t,
                                             AppVisitor av) throws IllegalParameterException {
        Page<Application> page = webPage.toPage();
        if (!page.hasRule4Field("roleId") || !page.hasRule4Field("roleUuid")) {
            throw new IllegalParameterException(Exceptions.CODE_ERROR_PARAMETER, "roleId,roleUuid参数错误。");
    ...
    public @ResponseBody
    Result<Page<Application>> page4KhSysRole(@RequestBody WebPage webPage, Trace t,
                                             AppVisitor av) throws IllegalParameterException {
        Page<Application> page = webPage.toPage();
        if (!page.hasRule4Field("roleId") || !page.hasRule4Field("roleUuid")) {
            throw new IllegalParameterException(Exceptions.CODE_ERROR_PARAMETER, "roleId,roleUuid参数错误。");
    ...
    public @ResponseBody
    Result<Page<Application>> page4SelfKhRole(@RequestBody WebPage webPage, Trace t,
                                              AppVisitor av) throws IllegalParameterException {
        Page<Application> page = webPage.toPage();
        if (!page.hasRule4Field("roleId") || !page.hasRule4Field("roleUuid")) {
            throw new IllegalParameterException(Exceptions.CODE_ERROR_PARAMETER, "roleId,roleUuid参数错误。");
